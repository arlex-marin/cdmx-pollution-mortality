...
El conjunto de datos procesado completo está disponible en OSF:

> Marín-García, A. (2026). *Datos Procesados: Contaminación del Aire y Mortalidad por Cáncer de Pulmón en la Ciudad de México (2004–2022)* [Conjunto de datos]. OSF. https://osf.io/78tpn/
...
**Citación:**
> Marín-García, A. (2026). *Informe Final: Análisis Geoespacial de Contaminación del Aire y Mortalidad por Cáncer en la Ciudad de México* (Versión 1.0). GitHub. https://github.com/arlex-marin/cdmx-pollution-mortality
